...
Initiative: **Master On-Premise Systems and Networks Security**
...
Hence, mastering on-premise systems and networks security has been successful if we either ```learn how to do it properly``` or we ```succeed in understanding it completely```. 
